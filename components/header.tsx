                ...
                text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5'>
                    {links.map((link) => (
                        <motion.li className='h-3/4 flex items-center justify-center relative' key={link.hash}
                            ...
                            <Link className={clsx('flex w-full items-center justify-center px-3 py-3 hover:text-gray-950 transition dark:text-gray-200', {
                                "text-gray-950 dark:text-gray-500 dark:hover:text-gray-300": activeSection === link.name,
                            })} href={link.hash}
                                onClick={() => {
